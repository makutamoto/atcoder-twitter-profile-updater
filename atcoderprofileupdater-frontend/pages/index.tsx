            ...
            {loading ? (
                <div className="text-center">
                    ...
                    <div>
                        ...
                        <Button className="my-2" variant="danger" onClick={() => signOut()}>ログアウト</Button>
                        <Form.Group>
                            ...
                            <Form.Control
                                ...
                                value={atcoderID}
                                onChange={(event) => setAtCoderID(event.currentTarget.value)}
                            />
                        </Form.Group>
                        <div>
                            <Form.Check
                                ...
                                type="switch"
                                checked={banner}
                                onChange={(e: React.ChangeEvent<HTMLInputElement>) => setBanner(e.currentTarget.checked)}
                            />
                            <Form.Check
                                id="bio-switch"
                                inline
                                ...
                                type="switch"
                                checked={bio}
                                onChange={(e: React.ChangeEvent<HTMLInputElement>) => setBio(e.currentTarget.checked)}
                            />
                            <Form.Check
                                ...
                                type="switch"
                                checked={autoUpdate}
                                onChange={(e: React.ChangeEvent<HTMLInputElement>) => setAutoUpdate(e.currentTarget.checked)}
                            />
                        </div>
